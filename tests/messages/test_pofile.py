...
''')
        ...
        self.assertEqual('foofoo', message.id)
        self.assertEqual('VohVooooh', message.string)
        self.assertEqual(['This is an obsolete message'], message.user_comments)
...
''')
        ...
        self.assertEqual(1, len(catalog))
        message = catalog['bar']
        self.assertEqual('bar', message.id)
        self.assertEqual('Bahr', message.string)
...
msgstr ""''')
        catalog = pofile.read_po(buf)
        self.assertEqual(catalog['missing line number'].locations, [('broken_file.py', None)])
