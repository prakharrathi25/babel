...
""")
        ...
        self.assertEqual([(1, 'npgettext', ('Strings', 'pylon', 'pylons', None), []),
...
""")
        messages = list(extract.extract_python(buf, ('_',), ['NOTE:'], {}))
        self.assertEqual(('Hello, {name}!', None), messages[0][2])
        self.assertEqual(['NOTE: First'], messages[0][3])
        self.assertEqual('Foo Bar', messages[1][2])
        self.assertEqual([], messages[1][3])
        self.assertEqual(('Hello, {name1} and {name2}!', None), messages[2][2])
        self.assertEqual(['NOTE: Second'], messages[2][3])
        self.assertEqual('Heungsub', messages[3][2])
        self.assertEqual([], messages[3][3])
        self.assertEqual('Armin', messages[4][2])
        self.assertEqual([], messages[4][3])
        self.assertEqual(('Hello, {0} and {1}!', None), messages[5][2])
        self.assertEqual(['NOTE: Third'], messages[5][3])
        self.assertEqual('Heungsub', messages[6][2])
        self.assertEqual([], messages[6][3])
        self.assertEqual('Armin', messages[7][2])
